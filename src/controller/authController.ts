...
export const register = asyncErrorCatcher(
...
export const verifyEmail = asyncErrorCatcher(
  async (req: Request, res: Response) => {
...
export const forgetPassword = asyncErrorCatcher(
  async (req: Request, res: Response) => {
    let { email } = req.body;
    if (!email) {
...
export const resetPassword = asyncErrorCatcher(
  async (req: Request, res: Response) => {
